...
function deleteDatabundleProfile(text, phoneNumber, sessionId) {
  return new Promise(async (resolve) => {
    ...
    let {
      mongo_userId,
      QS_delete_databundle_name: deleteMe,
    ...
    if (textlength === 3) {
      ...
      let {
        mongo_userId,
        QS_delete_databundle_name: cachedName,
      } = await redisClient.hgetallAsync(`${APP_PREFIX_REDIS}:${sessionId}`);
...
module.exports = { deleteDatabundleProfile };
