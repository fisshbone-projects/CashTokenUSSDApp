...
function deleteCabletvProfile(text, phoneNumber, sessionId) {
  return new Promise(async (resolve) => {
    ...
    let {
      mongo_userId,
      QS_delete_cabletv_name: deleteMe,
    ...
    if (textlength === 3) {
      ...
      let {
        mongo_userId,
        QS_delete_cabletv_name: cachedName,
      } = await redisClient.hgetallAsync(`${APP_PREFIX_REDIS}:${sessionId}`);
...
module.exports = { deleteCabletvProfile };
